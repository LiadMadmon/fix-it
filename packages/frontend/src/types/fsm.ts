...
export enum FixRequestEvents { submit = 'submit', submissionError = 'submissionError', submitSuccess = 'submitSuccess', reset = 'reset', submitError = 'submitError', submissionSuccess = 'submissionSuccess', submissionRejected = 'submissionRejected', submissionFailed = 'submissionFailed' };
